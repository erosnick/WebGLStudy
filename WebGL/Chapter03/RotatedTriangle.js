...
function main() {
    ...
    var sinβ = Math.sin(radian);
    var cosβ = Math.cos(radian);

    var sinbLocation = getUniformLocation(gl, "sinβ");

    gl.uniform1f(sinbLocation, sinβ);

    var cosbLocation = getUniformLocation(gl, "cosβ");

    gl.uniform1f(cosbLocation, cosβ);
