...
function initVertexBuffers(gl) {
    var vertices = new Float32Array([0.0,  0.5, 10.0, 1.0, 0.0, 0.0,
    ...
    gl.vertexAttribPointer(positionLocation, 2, gl.FLOAT, false, size * 6, 0);
    ...
    gl.vertexAttribPointer(pointSizeLocation, 1, gl.FLOAT, false, size * 6, size * 2);

    // 连接position变量与分配给它的缓冲区对象
    gl.enableVertexAttribArray(pointSizeLocation);

    var colorLocation= getAttribLocation(gl, 'color');

    gl.vertexAttribPointer(colorLocation, 3, gl.FLOAT, false, size * 6, size * 3);
